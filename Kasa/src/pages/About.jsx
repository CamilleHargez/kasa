    ...
    return (
        <>
            ...
            <div className='sectionAbout'>
                <Collapse className='collapseFiability' title="Fiabilité" isOpen={fiabilityOpen} onToggle={() => setFiabilityOpen(!fiabilityOpen)}>
                ...
                <Collapse className='collapseRespect' title="Respect" isOpen={respectOpen} onToggle={() => setRespectOpen(!respectOpen)}>
                ...
                <Collapse className='collapseService' title="Service" isOpen={serviceOpen} onToggle={() => setserviceOpen(!serviceOpen)}>
                ...
                <Collapse className='collapseSecurity' title="Sécurité" isOpen={securityOpen} onToggle={() => setSecurityOpen(!securityOpen)}>
